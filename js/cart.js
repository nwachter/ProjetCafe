//Refaire ajout panier, affichage produits version Deux pages
(function () {
  ...
  [...quantities].forEach(function (quantity) {
    ...
    const inputField = quantity.querySelector('.card__quantity');
    ...
    //A FAIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIRE       -   QUANTITE
    ...
    function saveProduct(clickedBtn) {
      ...
      const prodQuantity = cardInfo.querySelector("span").textContent;
